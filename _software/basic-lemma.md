...
[here](https://github.com/typesAreSpaces/BasicLemma)
...
and both $$\frac{3}{16}x^2 - \frac{9}{16}x + \frac{1}{2}$$ and
$$\frac{3}{16}x^2 + \frac{9}{16}x + \frac{1}{2}$$ are non-negative over
the interval
